...
/**
 * The outcome of one {@link JavAITagRepository#classify} call -- which of {@code tagSet}'s candidate tags the
 ...
 * {@link JavAITagRepository#classify}'s own javadoc); {@code source = "manual"} taggings are never touched and so
 * never appear here.
 */
