 ...
 *
 * <p>Lives in {@code javai-model}, not {@code javai-completion}, for the same reason {@link JavAIList}/
 ...
 * collection types -- must live in the same module {@code PromptContext} does, or {@code javai-model}
