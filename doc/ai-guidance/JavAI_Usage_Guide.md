...
repository's root `pom.xml` (currently `0.1.3` — check there directly rather than assuming it
...
```kotlin
dependencies {
    implementation("io.github.dcaudell:javai-vector:0.1.3")
    implementation("io.github.dcaudell:javai-model:0.1.3")
    implementation("io.github.dcaudell:javai-substrate:0.1.3")
    implementation("io.github.dcaudell:javai-supervision:0.1.3")
    implementation("io.github.dcaudell:javai-collections:0.1.3")
    implementation("io.github.dcaudell:javai-persistence:0.1.3")
    implementation("io.github.dcaudell:javai-completion:0.1.3")
    implementation("io.github.dcaudell:javai-tagging:0.1.3")
}
```
