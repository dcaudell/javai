 ...
 * SupervisionPointcut}s: every registered {@code AsyncSupervisionListener} (javai-supervision) scoped to
 * this call is dispatched fire-and-forget -- observation only, no rewrite rights over arguments, return
 * value, or thrown exception, and no blocking of the calling thread regardless of how long a listener
 * takes. This is deliberately where "trigger other work in response to this call" belongs: an async
