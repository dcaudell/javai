...
/**
 * Marks a field as included in {@code dev.xtrafe.javai.model.PromptContext.defaultMarshall(Object)}'s
 ...
 * See {@code javai-model}'s {@code PromptContext} javadoc for the full marshalling design.
 *
 * <p><b>Shares its simple name with {@code dev.xtrafe.javai.model.PromptContext}</b> (the record this
